...
function handleContextMenu(e, file) {
    ...
    const createFolderLink = document.createElement('a');
    createFolderLink.href = '#';
    createFolderLink.textContent = 'Create Folder';
    createFolderLink.onclick = () => { createSubfolder(); contextMenu.style.display = 'none'; };
    contextMenu.appendChild(createFolderLink);

    if (file.is_dir) {
        const deleteFolderLink = document.createElement('a');
        deleteFolderLink.href = '#';
        deleteFolderLink.textContent = 'Delete Folder';
        deleteFolderLink.onclick = () => { deleteSubfolder(file.id); contextMenu.style.display = 'none'; };
        contextMenu.appendChild(deleteFolderLink);

        const renameFolderLink = document.createElement('a');
        renameFolderLink.href = '#';
        renameFolderLink.textContent = 'Rename Folder';
        renameFolderLink.onclick = () => { renameSubfolder(file.id); contextMenu.style.display = 'none'; };
        contextMenu.appendChild(renameFolderLink);
    }
...
function openFile(file) {
    ...
    if (file.is_dir) {
        ...
        // Попробуем открыть PDF напрямую в новой вкладке
